        ...
        : Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text("Hi, $_username", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                  ...
                  _upcomingEvents.isNotEmpty
                      ? Column(
                          children: _upcomingEvents
                              .map((event) => _buildEventCard(event['title']!, event['startTime']!))
                              .toList(),
                        )
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            FittedBox(child: Text(label, style: const TextStyle(fontSize: 11), textAlign: TextAlign.center)),
          ],
        ),
      ),
    );
