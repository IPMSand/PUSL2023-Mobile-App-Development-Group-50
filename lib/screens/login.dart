...
class PersonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Head
    canvas.drawCircle(Offset(size.width / 2, size.height / 4), size.width / 3,
        paint); // Adjusted head size

    // Body
    canvas.drawRect(
      Rect.fromCenter(
        center: Offset(size.width / 2, size.height / 2 + 10), // Adjusted body pos
        width: size.width / 2, // Adjusted body width
        height: size.height / 2, // Adjusted body height
      ),
      paint,
    );
    ...
    canvas.drawRect(
      Rect.fromLTWH(
        size.width / 2 + size.width / 6, // Adjusted leg position.
        size.height,
        size.width / 6,
        size.height / 3,
      ), // Adjusted leg width
